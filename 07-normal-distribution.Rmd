...
`r unhide()`
2. Read in the `kids` dataset from `https://ditraglia.com/data/child_test_data.csv` and calculate the sample means, covariance matrix, and correlation matrix of `mom.iq` and `kid.score`.
