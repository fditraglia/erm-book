...
```{r}
set.seed(420508570)
system.time(foo <- parallel::mcMap(get_bias_and_var, n = parameters$n, s_sq = parameters$s_sq, mc.cores = 2))
set.seed(420508570)
system.time(bar <- Map(get_bias_and_var, n = parameters$n, s_sq = parameters$s_sq))
all.equal(foo, bar)
```
