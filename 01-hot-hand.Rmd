...
c. A function that "glues together" a. and b.

Depending on the complexity of each of these functions, it may be helpful to write additional "helper functions" that carry out specific sub-tasks. This probably sounds a bit abstract, to let's see how it works using a simple example.

Each function is a self-contained entity that we can think about and test in isolation. Once we're sure that each function is working correctly 
