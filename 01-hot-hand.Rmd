...
```
4. Consider a basketball player who *does not* have a hot hand: each of her shots is independent of the others and her probability of success on a given shot is 1/2. 



**Bonus** Go back and change from `3` to `k`. How does this change things?
**Try simulating from a non iid process**
