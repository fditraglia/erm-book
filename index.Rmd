...
"The only way to learn how to do research is by doing research."

You have probably heard this truism more than once 
- The only way to learn how to do research is to do research.
- An assumption that
...
If you want to run your code on a multicore machine in Google's cloud, something we'll cover in this book, you do not wan to be paying a software license fee for every core that you use.
...
At the top of the list is the LASSO, a wildly popular technique for high-dimensional regression that we'll cover in this book.
...
Next on the list of new Stata features is linear programming, a technique that came to prominence in the late 1940s and which is also covered in this book.^[For a history of linear programming, see [Dantzig (1983)](https://link.springer.com/content/pdf/10.1007/978-3-642-68874-4_4.pdf). To be completely fair, the linear programming [algorithm](https://www.stata.com/new-in-stata/linear-programming/)
...
- R is hard to learn. It's certainly harder to learn than something like STATA, but it's also much more powerful. Also, Hal Varian's paper: [Economic Incentives in Software Design](https://people.ischool.berkeley.edu/~hal/Papers/Software.pdf). Monopolist may make software *too easy* to learn.
